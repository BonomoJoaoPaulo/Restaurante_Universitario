...
typedef struct student
{
    ...
    /* Criamos o _id_table_seating eh o id da mesa que o estudante esta sentado, sera usado em student_seat() e student_leave(),
    para manipular melhor os espacos livres nas mesas. */
    int _id_table_seating;
